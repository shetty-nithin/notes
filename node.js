...
const { get, method, template } = require("lodash");
...
// "require("./location")", then also the function inside the first
// module will run.
// Or in another words, when we import a module, it invokes the module.
...
6. Why is Node.js is single-threaded?
    ...
    * With this, it makes it scalable and efficient for applications to
    provide high performance and efficiency usnde high amount of load.
...
19. What are the difference between AJAX and Node.js?
            AJAX                            Node.js
    * Client-ide programming tech      * Server-side scripting language
...
26. What is the use of a middleware in Node.js?
    * A middleware is a simpl function that has ability to handle incoming
...
32. Why is express.js used?
    ...
    * ExpressJS uses management point that controls the flow of data
    between servers adn server-side applications.
...
39. What is the difference between readFile and createReadStream in Node.js?
    readFile:
        * This is used to read all of the content of a given file in an
        asynchronous manner
        * All of the content will be read into the memory before user can access it.
    createReadStream:
...
43. How does the DNS looup function work in Node.js?
...
45. What is the difference between setImmediate() and setTimeout()?
    * setImmediate() : This function is meant to execute a single script
    once the current event loop is complete.
