...
Winzorization:  Clips extreme values(1st and 99th percentile). This prevents a single "extreme" driver from skewing the entire cluster structure. 
...
How it learns:
    ...
    * Perceptron (The Artificial Neuron):
        Limitation: A single neuron is a linear model. It can only learn decision boundary that are stright lines or hyperplane.
